...
```{r}
csv <- read_csv("data/aspatial/acra_data/ACRAInformationonCorporateEntitiesW.csv")
```
...
write.csv(merged, file="data/aspatial/acraW.csv")
write_csv(not_found, file ="data/aspatial/not_foundW.csv")
