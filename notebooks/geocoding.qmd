...
```{r}
csv <- read_csv("data/aspatial/acra_data/ACRAInformationonCorporateEntitiesB.csv")
```
...
write.csv(merged, file="data/aspatial/acraB.csv")
write_csv(not_found, file ="data/aspatial/not_foundB.csv")
