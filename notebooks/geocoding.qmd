...
```{r}
csv <- read_csv("data/aspatial/acra_data/ACRAInformationonCorporateEntitiesOthers.csv")
```
...
write.csv(merged, file="data/aspatial/acraOthers.csv")
write_csv(not_found, file ="data/aspatial/not_foundOthers.csv")
...
print(list.files(path = "/data/aspatial/acra_data", full.names = TRUE))
...
for (file in csv_files) {
  ...
  merged = merge(livecompany, found, by.x='postal_code', by.y = 'results.POSTAL', all = TRUE)
  write.csv(merged, file="data/aspatial/acraG.csv")
